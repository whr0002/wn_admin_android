 ...
 */
public class FormAdapter extends ArrayAdapter<FormType>{


    public FormAdapter(Context context, int resource) {
        super(context, resource);
    }

    public FormAdapter(Context context, int resource, ArrayList<FormType> list){
