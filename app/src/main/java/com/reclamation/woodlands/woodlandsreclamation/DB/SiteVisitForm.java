...
public class SiteVisitForm extends Form{
    ...
    public byte[] NLF_Photo3;
    public byte[] NLF_Photo4;
    public byte[] NLF_Photo5;

    public byte[] AP_Photo1;
    public byte[] AP_Photo2;
    public byte[] AP_Photo3;
    public byte[] AP_Photo4;
    public byte[] AP_Photo5;
    public byte[] AP_Photo6;
    public byte[] AP_Photo7;
    public byte[] AP_Photo8;
    public byte[] AP_Photo9;
    public byte[] AP_Photo10;
    public byte[] AP_Photo11;
    public byte[] AP_Photo12;
    public byte[] AP_Photo13;
    public byte[] AP_Photo14;
    public byte[] AP_Photo15;

    public byte[] AD_Photo1;
    public byte[] AD_Photo2;
